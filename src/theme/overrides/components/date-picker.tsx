...
const desktopTypes = dateList.reduce((result: any, currentValue: any) => {
...
/* eslint-disable @typescript-eslint/no-explicit-any */
const timeTypes = timeList.reduce((result: any, currentValue: any) => {
	result[`Mui${currentValue}`] = {
		defaultProps: {
			slots: {
...
export const datePicker = (theme : ThemeTypes) => {
	return {
		MuiPickersLayout: {
			styleOverrides: {
				root: {
