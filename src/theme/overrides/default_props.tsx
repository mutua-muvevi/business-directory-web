...
const CheckboxIndeterminateIcon = (props: any) => (
	<SvgIcon {...props}>
...
const TreeViewCollapseIcon = (props: any) => (
	<SvgIcon {...props}>
...
const TreeViewExpandIcon = (props: any) => (
	<SvgIcon {...props}>
...
const TreeViewEndIcon = (props: any) => (
	<SvgIcon {...props}>
...
export function defaultProps(theme: ThemeTypes) {
	return {
		MuiAlert: {
			defaultProps: {
				iconMapping: {
